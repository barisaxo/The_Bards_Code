...
namespace Dialog
{
    public class Line
    {
        ...
        public VideoClip VideoClip { get; private set; } = null;

        public Line NextLine { get; private set; } = null;
        public State NextState { get; private set; } = null;
        public Dialogue NextDialogue { get; protected set; } = null;

        public Response[] Responses { get; protected set; } = null;
        ...
        public Line SetSpeakerIcon(Sprite sprites) { SpeakerIcon = new Sprite[1] { sprites }; return this; }
