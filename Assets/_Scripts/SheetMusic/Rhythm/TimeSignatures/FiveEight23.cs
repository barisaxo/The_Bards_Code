                    ...
                    switch (ms.Measures[m].Cells[c].Shape)
                    {
                        case CellShape.TL:
                            notes.Add(new Note()
                            {
                                ...
                                QuantizedRhythmicValue = RhythmicValue.DotQuarter,
                        ...
                        case CellShape.L:
                            ...
                            {
                                ParentCell = ms.Measures[m].Cells[c],
                                QuantizedRhythmicValue = ms.Measures[m].Cells[c].Quantizement == Quantizement.Eighth ? RhythmicValue.Half : RhythmicValue.Quarter,
                                Rest = ms.Measures[m].Cells[c].Rest,
                                TiesTo = ms.Measures[m].Cells[c].TiedTo,
                                BeatLocation = new BeatLocation
                                {
